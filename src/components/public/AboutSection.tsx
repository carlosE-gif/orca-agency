const STATS = [
  ...
  { value: '12', suffix: '+', label: 'Brand Identities' },
    ...
    <>
      ...
      >
        ...
        <div>
          ...
          >
            Fearless ideas that{' '}
            <em style={{ color: '#4569AD', fontStyle: 'italic' }}>
              make waves.
            </em>
          </h2>
          ...
          >
            Orca is a creative agency rooted in the energy of the Middle East.
            We craft brand identities, campaigns, and digital experiences that
            challenge convention, command attention, and leave a lasting mark.
            We don&apos;t blend in — we stand apart.
          </p>
        ...
        >
            ...
            >
              {ORCA_SVG_PATHS.map((d, i) => (
                <path
                  key={i}
                  d={d}
                  fill="rgba(69,105,173,0.6)"
                  stroke="rgba(69,105,173,0.3)"
                  strokeWidth="0.5"
                />
              ))}
              {/* Dorsal fin */}
              <path
                d="M95 40 C92 20 85 8 80 5 C88 15 90 28 92 40Z"
                fill="rgba(69,105,173,0.5)"
              />
              {/* Tail flukes */}
              <path
                d="M70 170 C60 180 48 185 42 180 C50 175 58 165 62 158 M130 170 C140 180 152 185 158 180 C150 175 142 165 138 158"
                stroke="rgba(69,105,173,0.5)"
                strokeWidth="2"
                fill="none"
              />
            </svg>
          ...
          >
            ...
            >
              The Orca Standard
              <br />
              <span style={{ color: '#4569AD' }}>Bold. Intelligent. Relentless.</span>
            </p>
          </div>
        </div>
      </section>
